...
project_SRE = 1416
k118_path = "C:/Users/mija.frossard/Documents/OneDrive - HESSO/RaD/Projet_Reuse-LCA/Cas études/K118/K118_Reuse_LCA_Calculation_vFP.xlsx"

# Code
k118_table = pd.read_excel(k118_path, sheet_name="LCI+LCIA", header=2)
k118_param = pd.read_excel(k118_path, sheet_name="Parameters", header=1, nrows=1)
k118_res_config = pd.read_excel(k118_path, sheet_name="Parameters", header=9, nrows=1)
results_factor = k118_res_config.iloc[0]["Results factor"]

new_inventory = k118_table[k118_table["Status"]=="New"]
reuse_inventory = k118_table[k118_table["Status"]=="Reused"]
reuse_inventory = k118_table[k118_table["Reuse_origin"]=="Ex-situ reuse"]

project_SRE = k118_param["Building SRE (m2)"]
...
fig.write_html("k118_ex-situ.html")
